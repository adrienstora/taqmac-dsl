 ...
 * </p>
 * <ul>
 *   <li>{@link fr.ut2j.m1ice.pdc.taqmac.metamodel.itineraire.impl.DestinationImpl#getAdresse <em>Adresse</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DestinationImpl extends MinimalEObjectImpl.Container implements Destination {
	...
	protected EClass eStaticClass() {
		return ItinerairePackage.Literals.DESTINATION;
	}
	...
	public void setAdresse(String newAdresse) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ItinerairePackage.DESTINATION__ADRESSE, oldAdresse,
					adresse));
	}
