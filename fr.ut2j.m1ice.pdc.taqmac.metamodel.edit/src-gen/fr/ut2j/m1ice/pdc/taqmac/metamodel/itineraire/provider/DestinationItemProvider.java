...
/**
 * This is the item provider adapter for a {@link fr.ut2j.m1ice.pdc.taqmac.metamodel.itineraire.Destination} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DestinationItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addAdressePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Destination_adresse_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Destination_adresse_feature",
								"_UI_Destination_type"),
						ItinerairePackage.Literals.DESTINATION__ADRESSE, true, false, false,
	...
	public String getText(Object object) {
		String label = ((Destination) object).getAdresse();
		return label == null || label.length() == 0 ? getString("_UI_Destination_type")
	...
	public void notifyChanged(Notification notification) {
		...
		case ItinerairePackage.DESTINATION__ADRESSE:
